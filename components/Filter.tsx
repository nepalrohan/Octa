...
<div className='flex flex-col items-center z-30 md:z-0 justify-center h-fit py-3 gap-4  md:gap-7 md:dark:bg-customdark dark:bg-gray-200  bg-gray-200 md:bg-gray-300 rounded-r-full  md:rounded-r-null p-2 '>
