...
const pathname = usePathname()
    return (
        ...
        <div className='w-full md:hidden px-2 py-3 dark:bg-customdark dark:shadow-white  flex items-center shadow-customdark  gap-4 shadow-lg z-40 bg-white  justify-between h-15 sticky rounded-t-xl bottom-0 left-0'>
